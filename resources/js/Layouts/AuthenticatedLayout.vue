...
onMounted(() => {
  window.Echo.channel("help-requests").listen("HelpRequestCreated", (event: any) => {
            ...
            <div class="hidden sm:flex sm:items-center sm:ms-6">
              ...
              <div class="ms-3 relative">
                <Dropdown align="right" width="48">
                  ...
                  <template #content>
                    <DropdownLink :href="route('profile.edit')"> {{ $t("messages.Profile") }} </DropdownLink>
        ...
        >
          <div class="pt-2 pb-3 space-y-1">
            <ResponsiveNavLink
              ...
              >{{ $t("messages.Dashboard") }}</ResponsiveNavLink
            >
          </div>
